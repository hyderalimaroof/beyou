...
export default {
    ...
    data() {
        return {
            modalIcon: '', // This will be set dynamically (e.g., 'fa-check-circle' for success)
            modalTitle: '', // Modal title (e.g., 'Order Placed Successfully')
            modalMessage: '', // Modal message (e.g., 'Thank you for your purchase!')
            redirectCountdown: 10, // Countdown timer in seconds
