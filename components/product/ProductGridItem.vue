    ...
    <div class="product-wrap mb-30">
        <div class="product-img">
            <n-link :to="`/product/${slugify(product.title)}`">
                <img class="default-img" :src="product.images[0].image" :alt="product.title">
